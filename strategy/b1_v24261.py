...
class B1V24261Strategy(BaseStrategy):
    ...
    def __init__(self, params=None):
        ...
        super().__init__("B1 (V2.42.61)", default_params)
    ...
    def select_stocks(self, df, stock_name="") -> list:
        ...
        return [{
            ...
            "reasons": reasons or ["满足 B1(V2.42.61) 条件"],
            "category": "b1_v24261",
            "yangyin_ratio_28": self._volume_ratio(latest, "VOL_YANG1", "VOL_YIN1"),
            "yangyin_ratio_14": self._volume_ratio(latest, "VOL_YANG2", "VOL_YIN2"),
            "yangyin_ratio_57": self._volume_ratio(latest, "VOL_YANG3", "VOL_YIN3"),
